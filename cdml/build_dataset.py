"""Cut a training cache straight from chapter-marked episodes.
    ...
    python -m cdml.chapters --shows "/mnt/n/MediaProcessing/Raw/Thundarr the Barbarian" ...

    # 2. cut clips (hours; resumable, safe to ctrl-C and rerun)
    python -m cdml.build_dataset --shows "/mnt/n/.../Thundarr the Barbarian" \
                                 "/mnt/n/.../The 13 Ghost of Scooby-Doo" \
                                 "/mnt/n/.../The Brady Bunch" \
                                 "/mnt/n/.../Scoobys All-Star Laff-A-Lympics" \
